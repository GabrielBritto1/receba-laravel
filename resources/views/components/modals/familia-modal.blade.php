            ...
            <form action="{{ route('familias.store') }}" method="POST">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                     ...
                     <input type="text" class="form-control" name="cpf" id="cpf" placeholder="00000000000" value="{{ old('cpf') }}" required>
                  </div>
                  <div class="col-md-3 form-group">
                  ...
                  <div class="col-md-4 form-group">
                     ...
                     <input type="text" class="form-control" name="telefone" id="telefone" placeholder="00000000000" value="{{ old('telefone') }}" required>
                  </div>
                  <div class="col-md-4 form-group">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                     ...
                     <select name="reside" id="reside" class="form-control" required>
                        ...
                        <option value="Não Informado" @if(old('reside')=='Não Informado' ) selected @endif>Não Informado</option>
                     </select>
                  </div>
