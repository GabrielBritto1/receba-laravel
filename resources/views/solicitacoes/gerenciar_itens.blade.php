...
<h1 class="text-bold"><i class="fas fa-clipboard-list"></i> Gerenciar Itens</h1>
@stop
@section('content')
               ...
               <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="align-middle">{{ $solicitacao->item?->nome ?? '—' }}</td>
                        ...
                        <form action="{{ route('itens.alterar_status_solicitacao', $solicitacao) }}" method="POST" class="d-flex">
                     ...
                     @empty
                     <tr>
                        <td class="align-middle text-center" colspan="7">Nenhuma solicitação em análise.</td>
                     </tr>
                     @endforelse
                  </tbody>
               </table>
            ...
            <div class="card-body table-responsive p-0">
               <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                     ...
                     @empty
                     <tr>
                        <td class="align-middle text-center" colspan="7">Nenhuma solicitação em montagem.</td>
                     </tr>
                     @endforelse
                  </tbody>
               </table>
            ...
            <div class="card-body table-responsive p-0">
               <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                     ...
                     @empty
                     <tr>
                        <td class="align-middle text-center" colspan="7">Nenhuma solicitação montada.</td>
                     </tr>
                     @endforelse
                  </tbody>
               </table>
            ...
            <div class="card-body table-responsive p-0">
               <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                     ...
                     @empty
                     <tr>
                        <td class="align-middle text-center" colspan="6">Nenhuma solicitação não aceita.</td>
                     </tr>
                     @endforelse
                  </tbody>
               </table>
