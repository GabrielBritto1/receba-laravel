...
<head>
    ...
    <title>
        ...
        @yield('title', config('adminlte.title', 'RECeBa - Registro de Entrega de Cestas Básicas'))
    ...
    @else
        @switch(config('adminlte.laravel_asset_bundling', false))
            ...
            @default
                ...
                <link rel="shortcut icon" href="{{ asset('assets/img/banner_vertical.png')}}" type="image/x-icon">
