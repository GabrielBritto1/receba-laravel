...
function cestasNaoSairam(page = 1) {
   ...
   $.get(`${window.location.origin}/cestas/list?page=${page}`, function (data) {
            ...
            cestasNaoSairam.forEach(item => {
               $("#listCestasNaoSairam").append(`
                  <tr>
                     ...
                     <td class="align-middle">
                        <a href="${window.location.origin}/cestas/entrega_familia/${item.id}" class="btn btn-warning btn-sm text-white">
